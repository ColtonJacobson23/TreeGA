...
# Don't take abs of results internally, just wrap expression in one abs to get total difference in a positive value
# Lower score = closer to results
# Think about how mutation and recombination work
...
def initialize_individual(genome: Node, fitness: int) -> Individual:
    """
